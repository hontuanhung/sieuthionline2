                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <li><a href="{{URL::to('/register-now-sale')}}"><i class="fa fa-user"></i> Bán hàng cùng chúng tôi</a></li>
                            <li><a href="{{URL::to('/login-shop')}}"><i class="fa fa-user"></i> Đăng nhập gian hàng</a></li>
                        ...
                        <ul class="list-unstyled list-inline">
                            ...
                            if($shop_id!=NULL && $customer_id==NULL){
                                ...
                                <li class="dropdown dropdown-small">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a style="float: left;" href="{{URL::to('/add-product')}}">Đăng sản phẩm</a></li>
                                        <li><a style="float: left;" href="{{URL::to('/profile-shop&'.$shop_id)}}">Gian hàng của tôi</a></li>
                                        <li><a style="float: left;" href="#">Đơn hàng của tôi</a></li>
                                        <li><a style="float: left;" href="{{URL::to('/logout-shop')}}">Đăng xuất</a></li>
                                    </ul>
                                </li>
                                <?php
                            }if($customer_id!=NULL && $shop_id!=NULL) {
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="./"><img src="{{('public/frontend/images/logo.png')}}"></a></h1>
                    </div>
                </div>
                
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="{{URL::to('/cart')}}"><i class="fa fa-shopping-cart fa-lg"></i> <span class="product-count" style="background: red;">5</span></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="navbar-collapse collapse">
                    ...
                    <form class="form-inline active-cyan-4" action="{{URL::to('/tim-kiem')}}" method="POST" style="float: right;padding-top: 12px;">
                        {{ csrf_field() }}
