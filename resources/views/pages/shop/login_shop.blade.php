    ...
    <div class="container">
        <div class="col-lg-6">
            ...
            <div class="card-body card-block">
                ...
                ?>
                <form action="{{URL::to('/login-sh')}}" method="post" class="form-horizontal">
                    {{ @csrf_field() }}
                    <div class="row form-group">
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3"></div>
                        <div class="col-12 col-md-9"><input type="password" id="hf-password" name="shop_password" placeholder="Mật khẩu" class="form-control">@if($errors->has('shop_password'))
