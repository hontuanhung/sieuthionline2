            ...
            <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="{{URL::to('/sigin-customer')}}" method="post" class="form-horizontal">
                                    {{ @csrf_field() }}
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"></div>
                                        <div class="col-12 col-md-9"><input type="text" name="phone_customer" placeholder="Số điện thoại" class="form-control">@if($errors->has('phone_customer'))
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"></div>
                                        <div class="col-12 col-md-9"><input type="password" name="password_customer" placeholder="Mật khẩu" class="form-control">@if($errors->has('password_customer'))
