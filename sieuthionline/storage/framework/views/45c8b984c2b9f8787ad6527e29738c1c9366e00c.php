                ...
                <div class="login-form">
                    <form action="<?php echo e(URL::to('/login')); ?>" method="post">
                        ...
                        <div class="register-link m-t-15 text-center">
                            <p>Bạn chưa có tài khoản admin ? <a href="<?php echo e(url('/register-admin')); ?>"> Đăng ký tại đây</a></p>
                        </div>
                    </form>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\sieuthionline\resources\views/admin_login.blade.php ENDPATH**/ ?>